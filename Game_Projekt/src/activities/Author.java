...
public class Author implements Activity {
    ...
    public Author(ArrayList<Element> elements, UDPPad pad, LogicManager.Observer observer) throws Exception {
        elements.clear();
        this.pad = pad;
        this.observer = observer;
        this.elements = elements;
        Animation a = new Animation(LogicManager.animationsLists.get("HubertJedynak"), 10);
        author = new Element(a, 300, 150, 0, elements);
        author.create();
